...
class UPSTest < Minitest::Test
  ...
  def test_rescheduled_delivery_date
    @carrier.expects(:commit).returns(xml_fixture('ups/rescheduled_delivery_date'))
    assert_equal Time.utc(2014,12,01), @carrier.find_tracking_info('1Z190YF60314545301').scheduled_delivery_date
  end
